...
parser.add_argument('--data',type=str,default='../PEMS07_flow',help='data path') #
parser.add_argument('--adjdata',type=str,default='../PEMS07_flow/adj_mat_07.pkl',help='adj data path') #
...
parser.add_argument('--num_nodes',type=int,default=883,help='number of nodes') #
...
def main():
    ...
    for iter, (x, y) in enumerate(dataloader['test_loader'].get_iterator()):
        ...
        with torch.no_grad():
            ...
            preds = model(testx, args.device).transpose(1,3)
            
        outputs.append(preds.squeeze())
    print(datetime.datetime.now()-pred)
